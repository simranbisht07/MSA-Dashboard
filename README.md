...
📊 Power BI Desktop – Main tool for data modeling and visualization
📂 Power Query – Used for cleaning, transforming, and structuring the Excel dataset
🧠 DAX (Data Analysis Expressions) – Created calculated measures for KPIs, trends, and aggregations
📝 Data Modeling – Structured tables to enable filtering, relationships, and dynamic content
...
-Which models are generating the most revenue?
...
-Helps identify best-selling brands, models, and cities
-Provides month-wise and day-wise sales breakdown
...
Displays the distribution of customer satisfaction (1–5 ratings).
Most customers gave 4–5 stars, showing strong product satisfaction.

### 💳 Transactions by Payment Method (Donut Chart)

Breakdown of purchase behavior by payment method:
-UPI
-Debit Card
-Cash
-Credit Card
UPI and Debit Cards contribute the highest share.

### 🏆 Brand Performance Table

A detailed summary showing each brand’s:
-Total Sales
-Total Quantity
-Total Transactions
Top brands include: Apple, OnePlus, Samsung, Vivo, Xiaomi

### 📱 Sales by Mobile Model (Horizontal Bar Chart)

Top-performing device models displayed visually.
Examples:
-iPhone SE (60M)
-OnePlus Nord (~58M)
-Samsung Galaxy (~56M)
...
High-selling models (iPhone SE, OnePlus Nord, Galaxy Note, etc.) can be prioritized.

📌 Customer Behavior Understanding
Customer ratings and payment patterns help refine customer-centric strategies.

📌 Regional Performance Analysis
Cities like Mumbai, Hyderabad, and Delhi dominate sales—helping allocate budgets smartly.
...
-Clear tracking of brand and model performance
